...
fn LogoCustomizationPanel() -> Element {
    ...
    let on_reset = move |_| {
        let default_logo = mechvibes_core::state::config::LogoCustomization::default();
...
fn BackgroundCustomizationPanel() -> Element {
    ...
    let on_reset = move |_| {
        let default_bg = mechvibes_core::state::config::BackgroundCustomization::default();
