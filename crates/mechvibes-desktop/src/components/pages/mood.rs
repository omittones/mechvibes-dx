use dioxus::prelude::*;
use lucide_dioxus::{
    CloudRain, CloudSunRain, Coffee, Flame, Moon, Pause, Play, Radio, SkipForward, TreePine,
    Volume2, VolumeOff, Waves, Wind, Zap,
};

use crate::components::ui::PageHeader;
use mechvibes_core::state::ambiance::{
    AmbiancePlayerState, get_global_ambiance_player_state_copy,
    initialize_global_ambiance_player_state, pause_all_ambiance_sounds, play_ambiance_sound,
    resume_all_ambiance_sounds, set_ambiance_sound_volume, set_global_ambiance_mute,
    set_global_ambiance_volume, stop_ambiance_sound, update_global_ambiance_player_state,
};
use mechvibes_core::state::music::{
    MusicPlayerState, get_global_music_player_state_copy, initialize_global_music_player_state,
